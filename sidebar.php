<input class="d-none" id="check" type="checkbox">
        <nav id="sidebar" class="position-sticky top-0 ">
            ...
            <div class="list-group mt-5 mb-5 w-100">
                <a href="./home.php" class="list-group-item list-group-item-action text-center"> <i class="bi bi-house-door pe-3"></i>Home</a>
                <a href="#" class="list-group-item list-group-item-action text-center"><i class="bi bi-bookmark pe-3"></i>Course</a>
                <a href="./list student.php" class="list-group-item list-group-item-action text-center"><i class="bi bi-mortarboard pe-3"></i>Student</a>
                <a href="./payment.php" class="list-group-item list-group-item-action text-center"><i class="bi bi-currency-dollar pe-3"></i>Payment</a>
            ...
            <a href="index.php" class="btn btn-primary btn-sm w-100  " style="background-color:#FAFFC1; border: none; color: black;">logout <i class="bi bi-box-arrow-right ms-2" ></i></a>
        </nav>